...
export CONSUMER_DONE="kafka:syncAsyncGate-done?brokers=$KAFKA_BROKERS&groupId=done&headerDeserializer=#kafkaStringHeaderDeserializer"

export PRODUCER_REPLY_TO="kafka:syncAsyncGate-replyTo?brokers=$KAFKA_BROKERS"
export CONSUMER_REPLY_TO="kafka:syncAsyncGate-replyTo?brokers=$KAFKA_BROKERS&groupId=replyTo"
